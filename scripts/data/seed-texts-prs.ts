...
export const seedTexts: SeedTextSource[] = [
  ...
  },
  {
    ...
    sentences: [
      { target: "دوستی که در قریه ما کلان شد، حالا در کابل زندگی می‌کند.", translit: "dōstī ke dar qarya-ye mā kalān shud, hālā dar kābul zendagī mēkunad.", en: "A friend who grew up in our village now lives in Kabul." },
  ...
  },
  {
    ...
    sentences: [
      ...
      { target: "دهقانی که این باغ را دارد، هر روز به آن آب می‌دهد.", translit: "dehqānī ke īn bāgh rā dārad, har rōz ba ān āb mēdehad.", en: "The farmer who owns this garden waters it every day." },
  ...
  },
  {
    ...
    sentences: [
      ...
      { target: "دفتری که او در آن کار می‌کند، نزدیک بازار است.", translit: "daftarī ke ō dar ān kār mēkunad, nazdīk-e bāzār ast.", en: "The office where he works is near the market." },
  ...
  },
  {
    ...
    sentences: [
      ...
      { target: "دهقانی که زمین کنار سرک داشت، آن را برای مکتب داد.", translit: "dehqānī ke zamīn kinār-e sarak dāsht, ān rā barāyi maktab dād.", en: "A farmer who had land beside the road gave it for the school." },
  ...
  },
  {
    ...
    sentences: [
      ...
      { target: "هر خانه مقداری پول داد و کارگران هم بدون معاش کار کردند.", translit: "har khāna meqdārī pul dād wa kārgarān ham bidūn-e ma'āsh kār kardand.", en: "Each household gave some money, and the workers also worked without pay." },
  ...
  },
  {
    ...
    sentences: [
      { target: "تاجری که در بازار کابل دکان داشت، تصمیم گرفت کار خود را کلان‌تر کند.", translit: "tājirī ke dar bāzār-e kābul dukān dāsht, tasmīm gereft kār-e khud rā kalāntar kunad.", en: "A trader who had a shop in Kabul's bazaar decided to expand his business." },
