...
export const seedTexts: SeedTextSource[] = [
  ...
  },
  {
    ...
    titleEn: "The tailor",
    sentences: [
      { target: "دکان خیاطی نزدیک خانه ما است.", en: "The tailor shop is near our house." },
      { target: "خیاط لباس نو می‌دوزد.", en: "The tailor sews new clothes." },
      { target: "من یک جامه سفید می‌خواهم.", en: "I want a white garment." },
      { target: "لباس من مقبول است.", en: "My clothes are beautiful." },
    ],
  },
  {
    slug: "l1-030",
    ...
    titleEn: "Green tea",
    sentences: [
      { target: "مادر در آشپزخانه است.", en: "Mother is in the kitchen." },
      { target: "او آب را جوش می‌دهد.", en: "She boils the water." },
      { target: "ما چای سبز می‌خوریم.", en: "We drink green tea." },
      { target: "چای بسیار گرم است.", en: "The tea is very hot." },
    ],
  },
  {
    slug: "l1-031",
    ...
    sentences: [
      { target: "نانوای در تنور نان می‌پزد.", en: "The baker bakes bread in the tandoor." },
      { target: "من دو نان گرم می‌خرم.", en: "I buy two hot breads." },
      { target: "نان با پنیر مزه دار است.", en: "Bread with cheese is tasty." },
      { target: "ما ناشتا می‌خوریم.", en: "We eat breakfast." },
    ],
  },
  {
    slug: "l1-032",
    ...
    sentences: [
      { target: "پدر یک قالین نو خرید.", en: "Father bought a new carpet." },
      { target: "قالین ما سرخ و کلان است.", en: "Our carpet is red and big." },
      { target: "ما روی قالین می‌نشینیم.", en: "We sit on the carpet." },
      { target: "اتاق ما حالا مقبول است.", en: "Our room is now beautiful." },
    ],
  },
  {
    slug: "l1-033",
    ...
    sentences: [
      { target: "امروز در کابل باران می‌بارد.", en: "Today it rains in Kabul." },
      { target: "کوچه‌ها پر از آب است.", en: "The alleys are full of water." },
      { target: "بچه‌ها در حویلی بازی می‌کنند.", en: "The children play in the yard." },
      { target: "هوا بسیار سرد است.", en: "The weather is very cold." },
    ],
  },
  {
    slug: "l1-034",
    ...
    titleEn: "Our garden",
    sentences: [
      { target: "در باغ ما درخت سیب است.", en: "In our garden there is an apple tree." },
      { target: "من یک سیب شیرین می‌خورم.", en: "I eat a sweet apple." },
      { target: "برادر من آب می‌آورد.", en: "My brother brings water." },
      { target: "ما زیر درخت می‌نشینیم.", en: "We sit under the tree." },
    ],
  },
  {
    slug: "l1-035",
    ...
    sentences: [
      { target: "زمستان است و برف می‌بارد.", en: "It is winter and it snows." },
      { target: "من کرتی گرم می‌پوشم.", en: "I wear a warm jacket." },
      { target: "برادرم کلاه خود را می‌پالید.", en: "My brother was looking for his hat." },
      { target: "ما به مکتب می‌رویم.", en: "We go to school." },
    ],
  },
  {
    slug: "l1-036",
    ...
    titleEn: "The bazaar",
    sentences: [
      { target: "روز جمعه بازار بیروبار است.", en: "On Friday the bazaar is crowded." },
      { target: "پدرم ترکاری و میوه می‌خرد.", en: "My father buys vegetables and fruits." },
      { target: "کچالو و پیاز ارزان است.", en: "Potatoes and onions are cheap." },
      { target: "ما خریطه‌ها را به خانه می‌بریم.", en: "We take the bags home." },
    ],
  },
  {
    slug: "l1-037",
    ...
    titleEn: "The guests",
    sentences: [
      { target: "امشب مهمان به خانه ما می‌آید.", en: "Tonight guests come to our house." },
      { target: "مادر قابلی پلو پخته است.", en: "Mother has cooked Qabili Palaw." },
      { target: "کاکایم از مزار آمده است.", en: "My uncle has come from Mazar." },
      { target: "همه ما بسیار خوش هستیم.", en: "We are all very happy." },
    ],
  },
  {
    slug: "l2-031",
    ...
    sentences: [
      { target: "پدرکلانم مریض است.", en: "My grandfather is sick." },
      { target: "ما او را به شفاخانه می‌بریم.", en: "We take him to the hospital." },
      { target: "داکتر او را معاینه می‌کند.", en: "The doctor examines him." },
      { target: "او باید دوا بخورد تا جور شود.", en: "He must take medicine to get well." },
    ],
  },
  {
    slug: "l2-032",
  ...
  },
  {
    ...
    sentences: [
      { target: "شاگردان مکتب به چکر می‌روند.", en: "The school students go on a trip." },
      { target: "معلم ما در بس نشسته است.", en: "Our teacher is sitting in the bus." },
      { target: "ما به بند قرغه می‌رویم.", en: "We go to Qargha Dam." },
      { target: "در آنجا آب و هوا خوب است.", en: "There the weather is good." },
    ],
  },
  {
    slug: "l2-034",
    ...
    sentences: [
      { target: "برادرم کورس انگلیسی می‌خواند.", en: "My brother studies an English course." },
      { target: "او هر روز کتاب‌های نو می‌گیرد.", en: "He gets new books every day." },
      { target: "من هم می‌خواهم زبان یاد بگیرم.", en: "I also want to learn a language." },
      { target: "زبان خواندن برای آینده خوب است.", en: "Studying a language is good for the future." },
    ],
  },
  {
    slug: "l2-035",
    ...
    sentences: [
      { target: "خیاط لباس‌های زمستانی می‌دوزد.", en: "The tailor sews winter clothes." },
      { target: "من برای خود یک کرتی فرمایش دادم.", en: "I ordered a jacket for myself." },
      { target: "رنگ آن سیاه و تاریک است.", en: "Its color is dark black." },
      { target: "هفته آینده آن را می‌پوشم.", en: "Next week I will wear it." },
    ],
  },
  {
    slug: "l2-036",
    ...
    titleEn: "The market",
    sentences: [
      { target: "در مندوی کابل سودا ارزان است.", en: "In the Kabul Mandawi groceries are cheap." },
      { target: "دکاندارها برنج و روغن می‌فروشند.", en: "The shopkeepers sell rice and oil." },
      { target: "مردم از هر طرف می‌آیند.", en: "People come from every side." },
      { target: "روزانه پیسه زیاد تبادله می‌شود.", en: "Daily a lot of money is exchanged." },
    ],
  },
  {
    slug: "l2-037",
    ...
    titleEn: "The wedding",
    sentences: [
      { target: "دیشب ما در عروسی بودیم.", en: "Last night we were at a wedding." },
      { target: "موسیقی بسیار بلند بود.", en: "The music was very loud." },
      { target: "داماد و عروس خوشحال بودند.", en: "The groom and bride were happy." },
      { target: "ما تا دیر شب آنجا ماندیم.", en: "We stayed there until late at night." },
    ],
  },
  {
    slug: "l2-038",
    ...
    sentences: [
      { target: "سرک‌های کابل بسیار بیروبار است.", en: "The streets of Kabul are very crowded." },
      { target: "راننده‌ها هارن می‌زنند.", en: "The drivers honk." },
      { target: "ترافیک موترها را ایستاد می‌کند.", en: "The traffic police stops the cars." },
      { target: "باید در رانندگی احتیاط کنیم.", en: "We must be careful in driving." },
    ],
  },
  {
    slug: "l2-039",
    ...
    sentences: [
      { target: "مهمان‌ها در مهمانخانه نشسته‌اند.", en: "The guests are sitting in the guest room." },
      { target: "من برایشان چای و کلچه می‌برم.", en: "I take tea and cookies to them." },
      { target: "آنها درباره کار قصه می‌کنند.", en: "They tell stories about work." },
      { target: "پدرم با آنها می‌خندد.", en: "My father laughs with them." },
    ],
  },
  {
    slug: "l2-040",
    ...
    sentences: [
      { target: "سگ همسایه بسیار غالمغال می‌کند.", en: "The neighbor dog makes a lot of noise." },
      { target: "آن سگ کلان و سیاه است.", en: "That dog is big and black." },
      { target: "بچه‌ها از او می‌ترسند.", en: "The children are afraid of him." },
      { target: "صاحبش او را در حویلی بسته است.", en: "His owner has tied him in the yard." },
    ],
  },
  {
    slug: "l2-041",
    ...
    sentences: [
      { target: "سقف خانه ما آب می‌چکد.", en: "The roof of our house leaks water." },
      { target: "پدرم گلکار آورده است.", en: "My father has brought a mud-worker." },
      { target: "آنها بام را ترمیم می‌کنند.", en: "They repair the roof." },
      { target: "پیش از زمستان کار تمام می‌شود.", en: "The work will be finished before winter." },
    ],
  },
  {
    slug: "l2-042",
    ...
    sentences: [
      { target: "امروز در پوهنتون امتحان داریم.", en: "Today we have an exam at the university." },
      { target: "من دیشب بسیار درس خواندم.", en: "I studied a lot last night." },
      { target: "سوال‌ها کمی مشکل بود.", en: "The questions were a bit difficult." },
      { target: "امیدوارم نمره خوب بگیرم.", en: "I hope to get a good grade." },
    ],
  },
  {
    slug: "l2-043",
    ...
    sentences: [
      { target: "خواهر من یک طفل نو دارد.", en: "My sister has a new baby." },
      { target: "طفل بسیار خرد و مقبول است.", en: "The baby is very small and beautiful." },
      { target: "مادر من برای طفل کالا می‌دوزد.", en: "My mother sews clothes for the baby." },
      { target: "همه فامیل خوشحال هستند.", en: "The whole family is happy." },
    ],
  },
  {
    slug: "l2-044",
    ...
    sentences: [
      { target: "پدرم روز جمعه به مسجد می‌رود.", en: "My father goes to the mosque on Friday." },
      { target: "او با همسایه‌ها یکجا نماز می‌خواند.", en: "He prays together with the neighbors." },
