...
export const draftSeedTexts: SeedTextSource[] = [
  {
    ...
    sentences: [
      { target: "امروز هوا بسیار خوب است.", translit: "imroz hawa bisyar khob ast.", en: "Today the weather is very good." },
      { target: "ما به پارک می‌رویم.", translit: "ma ba park mērawēm.", en: "We are going to the park." },
  ...
  },
  {
    ...
    sentences: [
      { target: "من فردا به بازار می‌روم.", translit: "man farda ba bazar mērawam.", en: "I will go to the market tomorrow." },
      { target: "باید لباس جدید بخرم.", translit: "bayad libas-e jadid bukharam.", en: "I must buy new clothes." },
      { target: "برادرم هم با من می‌آید.", translit: "baradaram ham ba man mēayad.", en: "My brother is also coming with me." },
      { target: "او می‌خواهد یک کتاب بخواند.", translit: "o mēkhahad yak kitab bukhanad.", en: "He wants to read a book." },
      { target: "ما اول به دکان لباس می‌رویم.", translit: "ma awal ba dokan-e libas mērawēm.", en: "First, we go to the clothing store." },
      { target: "بعد از آن، یک کتابخانه پیدا می‌کنیم.", translit: "baad az an, yak kitabkhana payda mēkonēm.", en: "After that, we find a bookstore." },
      { target: "در آخر، به خانه برمی‌گردیم.", translit: "dar akhir, ba khana barmēgardēm.", en: "Finally, we return home." },
    ],
  },
  {
    slug: "l3-005",
    ...
    sentences: [
      { target: "مکتب ما بسیار نزدیک است.", translit: "maktab-e ma bisyar nazdēk ast.", en: "Our school is very close." },
      { target: "من هر روز پیاده می‌روم.", translit: "man har roz pyada mērawam.", en: "I walk there every day." },
      { target: "صنف ما کلان و روشن است.", translit: "sinf-e ma kalan wa roshan ast.", en: "Our classroom is big and bright." },
      { target: "معلم ما بسیار مهربان است.", translit: "moalim-e ma bisyar mihraban ast.", en: "Our teacher is very kind." },
      { target: "ما در صنف درس می‌خوانیم و می‌نویسیم.", translit: "ma dar sinf dars mēkhanēm wa mēnawīsēm.", en: "We study and write in class." },
      { target: "زنگ تفریح، با دوستانم صحبت می‌کنم.", translit: "zang-e tafrēh, ba dostanam sohbat mēkonam.", en: "During recess, I talk with my friends." },
  ...
  },
  {
    ...
    sentences: [
      { target: "امشب دوستانم به خانه ما می‌آیند.", translit: "imshab dostanam ba khana-ye ma mēayand.", en: "Tonight my friends are coming to our house." },
      { target: "من برای آن‌ها غذا می‌پزم.", translit: "man baray-e anha ghaza mēpazam.", en: "I am cooking food for them." },
      { target: "برنج و گوشت در آشپزخانه داریم.", translit: "birinj wa gosht dar ashpazkhana darēm.", en: "We have rice and meat in the kitchen." },
      { target: "من سالاد هم درست می‌کنم.", translit: "man salad ham dorost mēkonam.", en: "I am making a salad too." },
      { target: "خواهر بزرگم میز را آماده می‌کند.", translit: "khahar-e bozorgam mēz ra amada mēkonad.", en: "My older sister prepares the table." },
      { target: "مهمان‌ها ساعت هفت می‌رسند.", translit: "mihmanha saat-e haft mērasand.", en: "The guests arrive at seven o'clock." },
      { target: "ما با هم نان شب می‌خوریم.", translit: "ma ba ham nan-e shab mēkhorēm.", en: "We eat dinner together." },
    ],
  },
  {
    slug: "l3-007",
    ...
    titleEn: "A Rainy Day",
    sentences: [
      { target: "امروز باران می‌بارد.", translit: "imroz baran mēbarad.", en: "It is raining today." },
      { target: "آسمان تاریک است.", translit: "asman tarēk ast.", en: "The sky is dark." },
      { target: "من در خانه می‌مانم.", translit: "man dar khana mēmanam.", en: "I am staying at home." },
      { target: "یک پیاله چای گرم می‌نوشم.", translit: "yak pyala chay-e garm mēnusham.", en: "I drink a cup of warm tea." },
      { target: "از کلکین به بیرون نگاه می‌کنم.", translit: "az kilkīn ba bēron nigah mēkonam.", en: "I look outside from the window." },
  ...
  },
  {
    ...
    sentences: [
      ...
      { target: "فردا مهمان داریم.", translit: "fardā mihmān dārēm.", en: "Tomorrow we have guests." },
    ],
  },
  {
    slug: "l3-017",
