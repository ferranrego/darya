...
for (let i = 1; i <= 7; i++) {
  const batchPath = join(import.meta.dirname, "..", "scratch", `a2-batch${i}.txt`);
...
fs.writeFileSync(join(import.meta.dirname, "data", "core-lexicon-6.txt"), out);
console.log(`Wrote ${validWords.length} new A2 words (up to rank ${currentRank - 1})`);
