...
Current `formatVersion`: **1.0.0** — additive changes bump minor, breaking changes bump
major and get a migration note here.

| File | Schema | Contents |
|---|---|---|
| `content/lexicon/lexicon.json` | `lexicon.schema.json` | Dari lexemes: script, normalized form, transliteration, English gloss, POS, frequency rank + band (1–8), register, variants, example sentence, tags |
